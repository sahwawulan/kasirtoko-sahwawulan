            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('stok.destroy', ['stok' => $stok->id]) }}" method="post" style="display: none;" id="formBatal{{ $stok->id }}">
                            @csrf
                            @method('DELETE')
                        </form>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" onclick="event.preventDefault(); document.getElementById('formBatal{{ $stok->id }}').submit();">
                            Ya, Hapus!
                        </button>
                    </div>
                </div>
