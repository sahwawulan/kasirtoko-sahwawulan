...
class LaporanController extends Controller
{
    ...
    public function laporanTransaksiPelanggan()
{
    // Logika untuk mengambil data transaksi pelanggan dari database
    $transaksiPelanggan = TransaksiPelanggan::all();

    return view('laporan.transaksi_pelanggan', compact('transaksiPelanggan'));
}
